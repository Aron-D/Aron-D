...
- 🌱 Coding experience: C-programming (Experienced), C++ (Experienced), Python (Intermediate), Java (Experienced), PHP (not my interest. Experienced), Javascript (not my interest. Intermediate)
